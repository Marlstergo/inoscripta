      ...
      <div className="hidden w-1/2 bg-gray-100 lg:block">
        <div className="flex h-full flex-col justify-between p-8 lg:p-12">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold tracking-tight lg:text-5xl">Join AGGREGATOR Today</h1>
            <p className="text-lg text-gray-600">
              Create an account to personalize your news feed and never miss important updates.
            </p>
          </div>
          <Image
            src="/placeholder.svg"
      ...
      <div className="flex w-full items-center justify-center lg:w-1/2">
        <div className="w-full max-w-md space-y-8 px-4 sm:px-6">
          ...
          <form className="space-y-4">
            ...
            <Button className="w-full bg-black hover:bg-gray-900">Create account</Button>
          </form>
